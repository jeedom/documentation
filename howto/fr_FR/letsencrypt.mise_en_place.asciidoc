...
Pensez à reporter le code par défaut ci-dessous dans le virtualHost créé par le script de renouvellement : _/etc/apache2/sites-available/000-default-le-ssl.conf_
----
...
Saisir les lignes ci-dessous dans le fichier créé précédemment. Le copier/coller fonctionne via putty.
...
Sauvegarder le fichier puis quitter l'éditeur de texte (nano)
----
