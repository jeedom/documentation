...
Chaque module Edisio sur réseau électrique, a la possibilité de fonctionner comme un répéteur sans fil avec les autres modules, afin d'assurer une couverture totale de votre habitation.
...
* Création : Indique la date à laquelle l'équipement a été créé
