...
|image:../images/compatibility_list/tb05.jpg[width=150,align="center"]|E-Diffuser|Tb05|TB05|Diffuseur|Il est recommandé d'utiliser l'option garder la connexion. Obligatoire pour tenter expérimentalement l'accès aux couleurx directes |Mode inclusion|
//
